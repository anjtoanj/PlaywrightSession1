...
function displayRoles(roleName:Roles){
   console.log(`Existing roles : ${roleName}`);
...
reportRole(rolePermission.create);
reportRole(rolePermission.edit);
reportRole(rolePermission.delete);
reportRole(rolePermission.view);
