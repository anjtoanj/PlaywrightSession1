...
var Dashboard = /** @class */ (function () {
    ...
    Dashboard.prototype.resolutionCentre = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.page.fill('#email', "anjtoanj@gmail.com")];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.page.fill('#message', "hello")];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.page.locator("span[text='Send']").click()];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                }
